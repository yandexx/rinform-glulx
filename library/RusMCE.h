...
! Относительное местоимение в предложном падеже, согласованное с 'obj'
! ("на котором", "на которой", "на которых")
[ WhomTX obj;
...
! Относительное местоимение в родительном падеже, согласованное с 'obj'
! ("внутри которого", "внутри которой", "внутри которых")
[ WhomTXGen obj;
...
! Относительное местоимение в творительном падеже, согласованное с 'obj'
! ("над которым", "над которой", "над которыми")
[ WhomTXIns obj;
